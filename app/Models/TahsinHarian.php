...
class TahsinHarian extends Model
{
    use HasFactory;
    ...
    public static function indexHarian()
    {
        ...
        if (auth()->user()->hasRole('admin')) {
            $data = TahsinHarian::when($mulai && $akhir, function ($query) use ($mulai, $akhir) {
            ...
            $data = TahsinHarian::where('user_id', auth()->user()->id)
