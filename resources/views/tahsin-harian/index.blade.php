    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="{{ url('/tahsin-harian/tambah') }}" class="btn btn-sm btn-primary float-right">+ Tambah</a>
                <a href="{{ url('/tahsin-harian/export') }}{{ $_GET?'?'.$_SERVER['QUERY_STRING']: '' }}" class="btn btn-sm btn-success">Export</a>
            </div>
            <div class="card-body">
                <form action="{{ url('/tahsin-harian') }}">
