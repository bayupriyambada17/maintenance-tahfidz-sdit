    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="{{ url('/pencatatan-harian/tambah') }}" class="btn btn-sm btn-primary float-right">+ Tambah</a>
                <a href="{{ url('/pencatatan-harian/export') }}{{ $_GET?'?'.$_SERVER['QUERY_STRING']: '' }}" class="btn btn-sm btn-success">Export</a>
            </div>
            <div class="card-body">
                <form action="{{ url('/pencatatan-harian') }}">
                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('/pencatatan-harian/delete/'.$d->id) }}" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
