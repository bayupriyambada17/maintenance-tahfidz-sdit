    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="{{ url('/users/tambah-user') }}" class="btn btn-sm btn-primary float-right">+ Tambah</a>
                    ...
                    <tbody>
                        @foreach ($data_user as $du)
                            <tr>
                                ...
                                <td>{{ $du->telepon }}</td>
                                <td>
                                    <a href="{{ url('/users/detail/'.$du->id) }}" title="Detail" class="btn btn-sm btn-primary"><i class="fa fa-solid fa-eye"></i></a>
                                    <a href="{{ url('/users/edit-password/'.$du->id) }}" title="Edit Password" class="btn btn-sm btn-info"><i class="fa fa-solid fa-key"></i></a>
