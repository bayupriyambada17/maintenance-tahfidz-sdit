    ...
    <div class="container-fluid">
        <center>
            <div class="card col-lg-5">
                <div class="p-3">
                    <form method="post" action="{{ url('/surat/update/'.$data->id) }}">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('first_ayat') is-invalid @enderror" id="first_ayat" name="first_ayat" value="{{ old('first_ayat', $data->first_ayat) }}">
                            @error('first_ayat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('last_ayat') is-invalid @enderror" id="last_ayat" name="last_ayat" value="{{ old('last_ayat', $data->last_ayat) }}">
                            @error('last_ayat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order', $data->order) }}">
                            @error('order')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
